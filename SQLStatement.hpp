...
namespace ECE141 {
  ...
  public:
    ...
    AlterTableStatement(SQLInterpreter &anInterpreter);
    
    StatusResult addAttribute(Tokenizer &aTokenizer);
    StatusResult modifyAttribute(Tokenizer &aTokenizer);
    StatusResult dropAttribute(Tokenizer &aTokenizer);
