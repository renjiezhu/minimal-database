...
namespace ECE141 {
    ...
    bool Expression::operator()(KeyValues &aList) {
        ...
        switch (op) {
            case Operators::equal_op: return theLHS == theRHS;
                break;
            case Operators::notequal_op: return !(theLHS == theRHS);
                break;
            case Operators::lt_op: return theLHS < theRHS;
                break;
            case Operators::lte_op: return !(theRHS < theLHS);
                break;
            case Operators::gt_op: return theRHS < theLHS;
                break;
            case Operators::gte_op: return !(theLHS < theRHS);
                break;
