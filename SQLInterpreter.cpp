        ...
        if (aTokenizer.remaining()) {
            ...
            switch (theToken.keyword) {
                ...
                case Keywords::drop_kw    : theResult = new DropTableStatement(*this);
                    break;
                case Keywords::insert_kw  : theResult = new InsertStatement(*this);
                    break;
                ...
                case Keywords::describe_kw: theResult = new DescribeStatement(*this);
                    break;
                case Keywords::show_kw: theResult = new ShowTablesStatement(*this);
                    break;
                case Keywords::alter_kw   :theResult = new AlterTableStatement(*this);
                    break;
                default: break;
            }
            if (theResult) {
