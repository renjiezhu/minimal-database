    ...
    StatusResult RGTokenizer::tokenize() {
        ...
        while (!input.eof()) {
            ...
            if (isPunctuation(theChar)) {
                ...
                switch (theChar) {
                    case comma          : theType = TokenType::comma;
                        break;
                    case colon          : theType = TokenType::colon;
                        break;
                    case left_paren     : theType = TokenType::lparen;
                        break;
                    case right_paren    : theType = TokenType::rparen;
                        break;
                    case left_bracket   : theType = TokenType::lbracket;
                        break;
                    case right_bracket  : theType = TokenType::rbracket;
                        break;
                    case left_brace     : theType = TokenType::lbrace;
                        break;
                    case right_brace    : theType = TokenType::rbrace;
                        break;
                }
    ...
    void RGTokenizer::dump() {
        for (auto &theToken : tokens) {
            ...
            switch (theToken.type) {
                ...
                case TokenType::slash:std::cout << "punct " << theToken.data << std::endl;
                    break;
                ...
                case TokenType::plus:
                case TokenType::minus:std::cout << "operator " << theToken.data << std::endl;
                    break;

                case TokenType::number:std::cout << "number " << theToken.data << std::endl;
                    break;

                case TokenType::string:std::cout << "string " << theToken.data << std::endl;
                    break;

                case TokenType::identifier:std::cout << "identifier " << theToken.data << std::endl;
                    break;

                case TokenType::keyword:std::cout << "keyword " << theToken.data << std::endl;
                    break;
