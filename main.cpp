...
void showError(ECE141::StatusResult &aResult) {
    switch (aResult.code) {
        case ECE141::unknownCommand: std::cout << "Unknown command ";
            break;
        case ECE141::unknownDatabase: std::cout << "Unknown database ";
            break;
        case ECE141::unknownTable: std::cout << "Unknown table ";
            break;
